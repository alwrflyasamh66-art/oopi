...
def handle_messages(app, message):
    ...
    name2 = "ميرال"
    bot_r = [
f"اسمي {name}","طير","مش بوته!","اسكت","تراها زاقه","الله يعين","ياصبر الارض","هاه",name2,"؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟","تراك ازعجتنا","الله يصبرني",]
    bot_name = [
"عيونها","هلا",
"نعم","امرني ياعيوني","قلبو","قول شن عندك","سم","امرني",
"هلا والله","ها يعمري",
"نييم","روحها","هاه",
"زفت",
f"الله ياخذ {name}","قلبو","ها ",f"الله يرزقك حياة غير {name} ",
"تواصل مع مدير اعمالي","سم لبيه امر",
"عيوني","؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟",]
    sb = [
"عييييييييب","عيب","ياغبي عيب","يا قليل التربيه","يا قليل الادب","؟؟؟؟؟؟","ياليت تتأدب","بقص لسانك","حاضر","ياخي عيب","؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟","استغفر الله",
   ]
    lovem = [
"ياقلبووو",
"اكثر",
...
"عييييييييب","عيب","زق بوجهك","يا قليل التربيه","يا قليل الادب","؟؟؟؟؟؟","ياليت تتأدب","بقص لسانك","حاضر","ياخي عيب","؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟",]
    mm = [
"ليك اكتر من ساعة","احبك","اكثر","ترا ازعجتنا","برا","طيب","مش اكثر مني","وبعدين ؟","جت من الله","توكل بس"]
